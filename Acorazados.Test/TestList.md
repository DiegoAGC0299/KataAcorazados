...
- [] Si hay un destructor en el tablero con coordenada inicial 1,2, recibo dos disparos con coordenadas 1,2 y 2,2, debe asignar 'x' en la segunda coordenada y mostrar en mensaje 'Tiro exitoso'
- [] Si hay un destructor en el tablero, recibo tres disparos con coordenadas 1,2 2,2 y 3,2, debe mostrar en mensaje 'Barco hundido' y asignar 'X' en cada coordenada del barco.
