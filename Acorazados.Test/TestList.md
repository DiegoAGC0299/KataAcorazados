...
- [] Si hay un cañonero en el tablero, recibo un disparo con coordenadas 1,2 y hay coincidencia, debe mostrar en mensaje del tiro 'Barco hundido' y asignar 'X' a la coordenada del barco.
